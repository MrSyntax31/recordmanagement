...
<div id="log"> <a href="index.php">Home | <a href="offices.php">Offices</a> | Clients |  <a href="../index.php">Logout</a>
</div>
<div id="formdesign">
<input type="text" name="filter" value="" id="filter" placeholder="Search User..." autocomplete="off" />
<a rel="facebox" href="addUser.php" id="add">Add Clients</a>
</div>
...
<tbody>
	...
	<tr class="record">
		...
		<td><a rel="facebox" href="editUser.php?id=<?php echo $row['id']; ?>"> Edit </a> | <a href="#" id="<?php echo $row['id']; ?>" class="delbutton" title="Click To Delete">Delete</a> | <input name = "delete" type = "submit" 
